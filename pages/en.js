    ...
    <>
      ...
      <section style={{ padding:"80px 24px 60px", textAlign:"center", maxWidth:700, margin:"0 auto" }}>
        ...
        <div style={{ marginTop:24, display:"flex", justifyContent:"center" }}>
          <a href="https://apps.apple.com/app/id6782052054" target="_blank" rel="noopener noreferrer" style={{ display:"inline-flex", alignItems:"center", gap:11, background:"#1A1A1A", color:"white", padding:"10px 22px", borderRadius:12, textDecoration:"none" }}>
            ...
            <div style={{ textAlign:"left", lineHeight:1.15 }}>
              <div style={{ fontSize:10, opacity:0.85, letterSpacing:0.5 }}>DOWNLOAD ON THE</div>
