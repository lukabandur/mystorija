  ...
  return (
    <>
      ...
      <div style={{ maxWidth:900, margin:"40px auto 0", padding:"0 20px", display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))", gap:20 }}>
        <img src="/images/ad1.jpg" alt="Mystorija – KI Ideen und Anleitungen" style={{ width:"100%", borderRadius:20, boxShadow:"0 8px 40px rgba(0,0,0,0.12)", display:"block" }} loading="lazy" />
        <img src="/images/ad2.jpg" alt="Mystorija – Vorher Nachher KI Makeover" style={{ width:"100%", borderRadius:20, boxShadow:"0 8px 40px rgba(0,0,0,0.12)", display:"block" }} loading="lazy" />
      </div>
