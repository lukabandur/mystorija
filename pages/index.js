  ...
  return (
    <>
      ...
      <section style={{ padding:"80px 24px 60px", textAlign:"center", maxWidth:700, margin:"0 auto" }}>
        ...
        {/* APP STORE BADGE — nach Freigabe: <div> durch <a href="APP_STORE_LINK"> ersetzen + Text auf "Im App Store laden" */}
        <div style={{ marginTop:24, display:"flex", justifyContent:"center" }}>
          <div style={{ display:"inline-flex", alignItems:"center", gap:11, background:"#1A1A1A", color:"white", padding:"10px 22px", borderRadius:12 }}>
            ...
            <div style={{ textAlign:"left", lineHeight:1.15 }}>
              <div style={{ fontSize:10, opacity:0.85, letterSpacing:0.5 }}>BALD VERFÜGBAR IM</div>
