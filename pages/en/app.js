...
const KOMPLETT_PLAENE = [
  ...
  },
  {
    ...
    phasen:[
      ...
      { name:"Akzentwand", items:["Möbel von der wall wegstellen","Tesa Precision abglue (ceiling, floor, walls)","Tiefenground apply when noetig","2 Schichten wallfarbe mit Lammfellrolle","Band nass abziehen bei Latexfarbe","Trockenzeit: mind. 4h zwischen Schichten"] },
  ...
  },
  {
    ...
    phasen:[
      ...
      { name:"Kopfteil DIY", items:["MDF 18mm on Mass (OBI schneidet zu)","5cm Schaumstoff RG35 aufglue","Bouclé-Stoff spannen und tackern","An wall haengen (verdeckte Schroughben)"] },
